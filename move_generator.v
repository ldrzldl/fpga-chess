...
module move_generator (
    input wire        is_turn_white,        // <-- 추가: 현재 턴이 백(White)이면 1, 흑(Black)이면 0
    ...
    rook_move_generator rmg(start_pos_board & rook_board, team_board, team_board || opponent_board, rook_move_board);
